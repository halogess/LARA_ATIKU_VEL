...
@section('content')
    <div class="block md:flex p-10 h-auto justify-between gap-10">
        <a href="{{ url('master/transaksi/active') }}"
            ...
            <div class="w-11/12 items-center">
                <div class="w-full flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-truck w-1/3" viewBox="0 0 16 16">
                        <path
        ...
        <a href="{{ url('master/transaksi/history') }}"
            ...
            <div class="w-11/12 items-center">
                <div class="w-full flex justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        class="bi bi-clock-history w-1/3" viewBox="0 0 16 16">
                        <path
